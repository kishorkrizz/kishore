...
<body data-spy="scroll" data-target=".navbar" data-offset="50" onload="myFunction()"> 
    ...
    <div>  
       <div class="jumbotron">
          <h2 class="animated bounce">Restaurant Management</h2>      
          <p>food to every corner.</p>
        </div>
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <h1 class="animated rubberBand" >Restaurant Management System</h1>
            <p>food to every corner</p>
            
            <?php if(isset($_SESSION['username'])==true) { ?>
            <a class="btn btn-success" style="text-align: center" href="booking.php">order food</a>
            
            <?php } else{  ?>
            <a class="btn btn-success" style="text-align: center" href="login.php">Login To order food</a> 
            <?php } ?>
       ...
       <br><br>
        <div id="bus_route" class="container">
          <div class="page-header">
            <h1 style="text-align: center">Derlivery Route</h1>      
          </div> 
          <div class="row">
              <div class="col-md-6 foo">
                <p><b>We deliver to every corner of the city.</b></p>
        ...
        <div id="driver" class="container">
          ...
          <div class="row">
              <div class="col-md-12">
                  <p style="font-size: 20px;">Great restaurants are, of course, a wonderful part of the hospitality industry, but they are only one part of the equation.</p>
        ...
        <div id="bus" class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 foo1">
                  <p style="font-size:20px;"><b>A good restaurant is like a vacation; it transports you, and it becomes a lot more than just about the food.</b></p>
              </div>
